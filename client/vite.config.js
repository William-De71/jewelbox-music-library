  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: '/',
        icons: [
          { src: '/icons/icon-192.png.png', sizes: '192x192', type: 'image/png' },
          { src: '/icons/icon-512.png.png', sizes: '512x512', type: 'image/png' },
          { src: '/icons/icon-512.png.png', sizes: '512x512', type: 'image/png', purpose: 'any maskable' },
        ],
      },
      workbox: {
